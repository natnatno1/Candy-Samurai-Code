...
public class BubbleGum : MonoBehaviour {
    ...
    // What to do when the mouse is over the bubblegum
    void OnMouseOver()
    {
        // What to do when the mouse is over the bubblegum and the mouse button is down
        if (mousedown == true)
        {
            ...
            // Set the BubbleGumPopped variable in the Game Manager Script to true
            GameObject.Find("GameManager").GetComponent<GameManagerScript>().BubbleGumPopped = true;
